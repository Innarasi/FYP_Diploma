...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form5")) {
  $updateSQL = sprintf("UPDATE supplier SET `Contact Number`=%s, email=%s, address=%s WHERE name=%s",
...
$totalRows_Supplier = mysql_num_rows($Supplier);mysql_select_db($database_Kitabenaconnnection, $Kitabenaconnnection);
$query_Supplier = "SELECT * FROM supplier";
$Supplier = mysql_query($query_Supplier, $Kitabenaconnnection) or die(mysql_error());
$row_Supplier = mysql_fetch_assoc($Supplier);
            ...
            <tr>
              <td width="1127" bgcolor="#D47FFF"><p>&nbsp;</p>
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form5" id="form5">
                  ...
                  <input type="hidden" name="name" value="<?php echo $row_Supplier['name']; ?>" />
                </form>
                <p>&nbsp;</p>
<p>&nbsp;</p></td>
            </tr>
